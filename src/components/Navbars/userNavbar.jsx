      ...
      >
        <Container fluid>
          <div className="navbar-wrapper">
            ...
            <NavbarBrand href="/#/ዘ-EQUB/joined-equb">
              ዘ-Equb
            </NavbarBrand>
          </div>
          <button
          ...
          <Collapse navbar isOpen={this.state.collapseOpen}>
            <Nav className="ml-auto" navbar>
              ...
              <UncontrolledDropdown nav>
                ...
                >
                  <div className="photo">
                    <img alt="..." src={require("assets/img/images.jpg")}/>
                  </div>
                  <b className="caret d-none d-lg-block d-xl-block"/>
                  <p className="d-lg-none">Log out</p>
                </DropdownToggle>
                <DropdownMenu className="dropdown-navbar" right tag="ul">
                  <NavLink  href="/#/ዘ-EQUB/user-profile" >
...
export default  connect(mapStateToProps,{logoutAction, joinStateResetAction, payStateResetAction, statusStateResetAction, saleBuyStateResetAction})(UserNavbar);
